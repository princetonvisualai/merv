...
Factory class defining functions for instantiating various Training Strategies, supporting different VidLMs, backbones,
...
from merv.models.vidlms import VidLM
from merv.training.strategies import FSDPStrategy, TrainingStrategy
