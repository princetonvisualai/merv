...
class HFCausalLLMBackbone(LLMBackbone, ABC):
    def __init__(
        ...
        if "llama3-8b-pure" == llm_backbone_id:
        ...
        elif "llama3-8b-chat" == llm_backbone_id:
            # Use the pure tokenizer for now, not sure how to fix it o/w.
            self.tokenizer = AutoTokenizer.from_pretrained(
        ...
        # Validation =>> Our VidLM logic currently operates under the assumption that the tokenization of a new input
