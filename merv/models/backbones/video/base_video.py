...
class VideoBackbone(nn.Module, ABC):
    def __init__(
        self, vision_backbone_id: str, image_resize_strategy: str, default_image_size: int = 224, num_frames: int = 8
    ) -> None:
        super().__init__()
...
# class TimmViTBackbone(VideoBackbone, ABC):
#     def __init__(
#         self,
...
#             "file an issue or implement the requisite logic (see `merv/models/backbones/vision/base_vision.py`)!"
#         )
