...
Abstract class definition of a Video-Language Model (VidLM), with full annotations of class methods, utility functions,
and initialization logic. This is mostly to future-proof the codebase; while all our experiments instantiate
from MERV, theoretically, this base class should be general enough to cover almost all models in the future.
...
class VidLM(nn.Module, GenerationMixin, ABC):
    def __init__(
        self,
        model_family: str,
        model_id: str,
        ...
        self.video_backbones = torch.nn.ModuleList(video_backbones)
        self.enable_mixed_precision_training = enable_mixed_precision_training

        # Instance Attributes for a generic VidLM
